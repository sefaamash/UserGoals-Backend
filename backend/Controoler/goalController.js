...
//Now updated goal
     const updatedgoal =await Goal.findByIdAndUpdate(req.params.id,req.body,{new:true,}); //this will update the goal if id matched also print updated goal and if its not there it will make new which we shown in 3rd para,meter
